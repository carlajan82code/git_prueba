...
<div class="footer_contenido">
			...
			<div class="footer_contenido-contacto">
			  ...
			  <div class="footer_redes">
				<img src="./img/instagram.png" alt="red Instragram" href="">
				<img src="./img/twiter.png" alt="red twiter" class="icono-twitter">
				<img src="./img/linkedin.png" alt="red linkedin">
				<img src="./img/whatsapp.png" alt="red whatsapp" class="icono-whatsapp">
